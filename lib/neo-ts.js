...
(function (Neo) {
    let _max, _min;
    class Uint64 extends Neo.UintVariable {
...
(function (Neo) {
    ...
    class Fixed8 {
        ...
        static get MaxValue() { return _max || (_max = new Fixed8(new Neo.Uint64(0xffffffff, 0x7fffffff))); }
        static get MinusOne() { return _minus || (_minus = new Fixed8(new Neo.Uint64(0xffffffff, 0xffffffff))); }
        static get MinValue() { return _min || (_min = new Fixed8(Neo.Uint64.MinValue)); }
        static get One() { return _one || (_one = Fixed8.fromNumber(1)); }
        static get Satoshi() { return _satoshi || (_satoshi = new Fixed8(new Neo.Uint64(1))); }
        ...
        static fromNumber(value) {
            ...
            if (value >= 0x8000000000000000)
                throw new RangeError();
            let array = new Uint32Array((new Neo.BigInteger(value)).toUint8Array(true, 8).buffer);
...
(function (Neo) {
    let _zero;
    class Uint160 extends Neo.UintVariable {
        constructor(value) {
            if (value == null)
...
(function (Neo) {
    let _zero;
    class Uint256 extends Neo.UintVariable {
        constructor(value) {
            if (value == null)
    ...
    (function (Cryptography) {
        class ECDsa {
            ...
            static generateKey(curve) {
                ...
                let pubkey = Cryptography.ECPoint.multiply(curve.G, prikey);
                return {
            ...
            sign(message) {
                ...
                let d = Neo.BigInteger.fromUint8Array(this.key.privateKey, 1, false);
                let r, s;
                do {
                    let k;
                    do {
                        ...
                        let p = Cryptography.ECPoint.multiply(this.key.publicKey.curve.G, k);
                        let x = p.x.value;
            ...
            static sumOfTwoMultiplies(P, k, Q, l) {
                ...
                let Z = Cryptography.ECPoint.add(P, Q);
            ...
            verify(message, signature) {
                ...
                let r = Neo.BigInteger.fromUint8Array(arr.subarray(0, 32), 1, false);
                let s = Neo.BigInteger.fromUint8Array(arr.subarray(32, 64), 1, false);
    ...
    (function (Cryptography) {
        class ECFieldElement {
            ...
            static fastLucasSequence(p, P, Q, k) {
                ...
                let Uh = Neo.BigInteger.One;
                let Vl = new Neo.BigInteger(2);
                let Vh = P;
                let Ql = Neo.BigInteger.One;
                let Qh = Neo.BigInteger.One;
            ...
            sqrt() {
                if (this.curve.Q.testBit(1)) {
                    let z = new ECFieldElement(Neo.BigInteger.modPow(this.value, this.curve.Q.rightShift(2).add(1), this.curve.Q), this.curve);
    ...
    (function (Cryptography) {
        class ECPoint {
                    ...
                    case 0x03:
                        {
                            ...
                            let X1 = Neo.BigInteger.fromUint8Array(encoded.subarray(1), 1, false);
                    ...
                    case 0x07:
                        {
                            ...
                            let X1 = Neo.BigInteger.fromUint8Array(encoded.subarray(1, 1 + expectedLength), 1, false);
                            let Y1 = Neo.BigInteger.fromUint8Array(encoded.subarray(1 + expectedLength), 1, false);
            ...
            static decompressPoint(yTilde, X1, curve) {
                let x = new Cryptography.ECFieldElement(X1, curve);
            ...
            static multiply(p, n) {
                let k = n instanceof Uint8Array ? Neo.BigInteger.fromUint8Array(n, 1, false) : n;
                if (p.isInfinity())
                    return p;
                if (k.isZero())
            ...
            twice() {
                ...
                let TWO = new Cryptography.ECFieldElement(new Neo.BigInteger(2), this.curve);
                let THREE = new Cryptography.ECFieldElement(new Neo.BigInteger(3), this.curve);
            ...
            static windowNaf(width, k) {
                ...
                while (k.sign() > 0) {
                    if (!k.isEven()) {
                        let remainder = Neo.BigInteger.remainder(k, pow2wB);
    ...
    (function (Cryptography) {
        class RandomNumberGenerator {
            ...
            static getRandomValues(array) {
                ...
                let aes = new Cryptography.Aes(RandomNumberGenerator._key, RandomNumberGenerator.getWeakRandomValues(16));
    ...
    (function (Cryptography) {
        ...
        if (window.crypto.subtle == null && w.msCrypto) {
            window.crypto.subtle = {
                decrypt: (a, b, c) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.decrypt(a, b, c); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                deriveBits: (a, b, c) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.deriveBits(a, b, c); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                deriveKey: (a, b, c, d, e) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.deriveKey(a, b, c, d, e); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                ...
                encrypt: (a, b, c) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.encrypt(a, b, c); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                exportKey: (a, b) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.exportKey(a, b); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                generateKey: (a, b, c) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.generateKey(a, b, c); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                importKey: (a, b, c, d, e) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.importKey(a, b, c, d, e); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                sign: (a, b, c) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.sign(a, b, c); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                unwrapKey: (a, b, c, d, e, f, g) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.unwrapKey(a, b, c, d, e, f, g); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                verify: (a, b, c, d) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.verify(a, b, c, d); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
                wrapKey: (a, b, c, d) => new NeoPromise((resolve, reject) => { let op = w.msCrypto.subtle.wrapKey(a, b, c, d); op.oncomplete = () => resolve(op.result); op.onerror = e => reject(e); }),
            };
        }
        if (window.crypto.subtle == null) {
            window.crypto.subtle = {
                decrypt: (algorithm, key, data) => new NeoPromise((resolve, reject) => {
                    ...
                    try {
                        let aes = new Cryptography.Aes(key.export(), algorithm.iv);
                ...
                return new NeoPromise((resolve, reject) => {
                    if (format != "jwk" || algorithm.namedCurve != "P-256")
                        ...
                        try {
                            ...
                            let pubkey = Cryptography.ECPoint.decodePoint(arr, Cryptography.ECCurve.secp256r1);
                            if (k.d)
...
(function (Neo) {
    ...
    (function (IO) {
        ...
        class MemoryStream extends IO.Stream {
            constructor() {
                super();
        ...
        class Op {
            ...
            getCodeName() {
                ...
                if (this.code > ThinNeo.OpCode.PUSHBYTES1 && this.code < ThinNeo.OpCode.PUSHBYTES75)
                    return name + "PUSHBYTES" + (this.code - ThinNeo.OpCode.PUSHBYTES1);
                else
